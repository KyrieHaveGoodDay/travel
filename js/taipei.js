// 台北旅遊api資料
var data_view = "https://ptx.transportdata.tw/MOTC/v2/Tourism/ScenicSpot/Taipei?$top=30&$format=JSON"
...
// 台北住宿api資料
var data_home = "https://ptx.transportdata.tw/MOTC/v2/Tourism/Hotel/Taipei?$top=30&$format=JSON"
var xhr = new XMLHttpRequest()
xhr.open('GET', data_home, true)
xhr.send()
xhr.onload = function () {
    var data = JSON.parse(this.responseText);
    //   console.log(data);
...
// 台北精選遊程api資料
var data_featured = "https://ptx.transportdata.tw/MOTC/v2/Tourism/Activity/Taipei?$top=30&$format=JSON"
var xhr = new XMLHttpRequest()
xhr.open('GET', data_featured, true)
xhr.send()
xhr.onload = function () {
    var data = JSON.parse(this.responseText);
    // console.log(data);   
